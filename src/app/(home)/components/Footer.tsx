...
const Footer = () => {
  return (
    <section className='py-20 bg-white dark:bg-neutral-950 mt-10 relative shadow shadow-black rounded-t-4xl'>
            ...
            <div className='flex flex-col items-start'>
              <div className='flex items-center gap-2'>
                <Image
                  ...
                  src={logos.logo7}
                />
                <h1 className='text-3xl font-bold text-black dark:text-white' style={{ fontFamily: 'var(--font-montserrat-alternates)' }}>
                  FingAI.
                </h1>
              </div>
