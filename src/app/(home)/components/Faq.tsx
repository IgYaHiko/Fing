  ...
  return (
     <section className='py-5 lg:pt-10 px-7 md:px-2'>
           <div className='container mx-auto flex flex-col items-center justify-center'>
             ...
             <h1 className=' mt-5 text-3xl lg:text-6xl text-center' style={{fontFamily: "var(--font-montserrat-alternates)", fontWeight: 700}}>Question ? We&apos;e got<span className=''> <GlowingGradientText> answers.</GlowingGradientText> </span></h1>
